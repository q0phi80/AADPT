...
SetAcl (Get-ADUser "ndongo.sima") (Get-ADUser "queen.makeda") "GenericAll" "None"
SetAcl (Get-ADUser "queen.makeda") (Get-ADUser "queen.nzinga") "GenericAll" "None"
...
SetAcl (Get-ADUser "queen.nzinga") (Get-ADUser "sundiata.keita") "WriteProperty" "All"